...
interface DemoDocumentsSectionProps {
  policyId: string;
}

export function DemoDocumentsSection({ policyId }: DemoDocumentsSectionProps) {
  const [documents, setDocuments] = useState<Document[]>([
    {
      id: "doc-1",
      fileName: "Policy_Declaration_2024.pdf",
      fileUrl: "#",
  ...
  const handleDelete = (documentId: string) => {
    if (!confirm("Are you sure you want to delete this document from the demo vault?")) return;
