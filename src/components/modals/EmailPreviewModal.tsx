...
export function EmailPreviewModal({
  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose} title="Renewal Notification Protocol" maxWidth="3xl">
      <div className="space-y-8 bg-white font-body p-2">
        {/* Recipient Info */}
        ...
        <div className="border border-black/10 rounded-2xl overflow-hidden shadow-xl">
            ...
            <div className="my-8 p-6 bg-slate-50 rounded-2xl border border-black/5">
              <table className="w-full text-sm">
                <tbody className="divide-y divide-black/5">
                  ...
                  <tr>
                    <td className="py-3 text-[10px] font-black text-on-surface/40 uppercase tracking-widest">Expiration Date</td>
          ...
          <div className="p-6 bg-slate-50 border-t border-black/5 text-center">
            <p className="text-[10px] font-black text-on-surface/20 uppercase tracking-[0.2em]">
              © 2024 RetainVault Intelligence Systems. High-premium asset protection.
            </p>
          </div>
        </div>
        ...
        {/* Actions */}
        <div className="flex items-center justify-end gap-6 pt-8 border-t border-black/5 bg-slate-50/50">
          <button
            onClick={onClose}
