const faqs = [
  {
    ...
    answer: 'Navigate to the Book of Business section and click the "Add Client" button. Fill in the required information including client details, policy information, and carrier selection. You can also import clients via CSV for bulk uploads.'
  },
  {
    question: 'How does the renewal automation work?',
    answer: 'Our renewal automation tracks policy expiration dates and sends automated reminders at 90, 60, and 30 days before renewal. You can customize automation rules in Settings to match your agency workflow and ensure no renewal falls through the cracks.'
  },
  {
  ...
  },
  {
    ...
    answer: 'Go to Settings > Carrier Integrations to connect your carrier portals. We support direct API integrations with major carriers. Contact your carrier representative to obtain API credentials, then enter them in the integration settings to enable real-time policy syncing.'
  },
  {
    question: 'How do I invite team members?',
    answer: 'Navigate to Settings > Team Management and click "Invite Team Member". Enter their email address and assign a role (Admin, Agent, or Viewer). They will receive an invitation email to join your agency workspace.'
  }
];
  ...
  return (
    <div className="max-w-5xl mx-auto space-y-12 py-8 font-body">
      <div className="text-center space-y-4">
        ...
        <p className="text-lg text-on-surface/60 font-medium max-w-2xl mx-auto italic">Access 24/7 technical and strategic assistance dedicated to your agency's authority and portfolio protection.</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div className="bg-surface p-10 rounded-[32px] border border-black/5 text-center hover:shadow-2xl hover:scale-[1.02] transition-all group">
          <div className="w-16 h-16 bg-secondary/5 rounded-2xl flex items-center justify-center mx-auto mb-6 group-hover:scale-110 group-hover:bg-secondary group-hover:text-white transition-all shadow-sm">
        ...
        <div className="bg-surface p-10 rounded-[32px] border border-black/5 text-center hover:shadow-2xl hover:scale-[1.02] transition-all group">
          <div className="w-16 h-16 bg-secondary/5 rounded-2xl flex items-center justify-center mx-auto mb-6 group-hover:scale-110 group-hover:bg-secondary group-hover:text-white transition-all shadow-sm">
            <span className="material-symbols-outlined text-3xl text-secondary group-hover:text-white">terminal</span>
          </div>
          <p className="font-black text-on-surface italic font-headline text-xl mb-1 tracking-tight">Intelligence Docs</p>
          <p className="text-[10px] font-black text-on-surface/40 uppercase tracking-widest">Carrier Protocol Registry</p>
        </div>
      </div>
    </div>
  );
