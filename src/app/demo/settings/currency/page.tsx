...
export default function DemoCurrencySettingsPage() {
  const mockAgency = {
    id: 'demo-agency',
    currency: 'USD',
  };
    ...
    <div className="space-y-10 font-body text-on-surface">
      <div className="flex items-center gap-5">
        ...
        <div>
          ...
          <p className="text-on-surface/60 mt-2 font-medium italic">Manage regional localization and financial display protocols (Demo)</p>
        </div>
      </div>

      <div className="grid lg:grid-cols-3 gap-8">
        <div className="lg:col-span-2">
          <CurrencySettingsForm agency={mockAgency as any} isDemo={true} />
        </div>
          ...
          <div className="bg-white rounded-[32px] p-8 border border-black/5 shadow-sm relative overflow-hidden group">
            ...
            <div className="space-y-5 relative z-10">
              <div className="flex flex-col gap-1 border-b border-black/5 pb-3">
                ...
                <span className="text-sm font-bold text-on-surface italic font-headline">USD</span>
              </div>
